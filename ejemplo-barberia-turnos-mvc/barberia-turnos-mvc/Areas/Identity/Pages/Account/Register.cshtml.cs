        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Nos aseguramos de que el rol exista ANTES de asignarlo.
                    // Sin este chequeo, si "Cliente" no está creado todavía
                    // en la base, AddToRoleAsync tira una excepción DESPUÉS
                    // de haber creado ya el usuario, dejándolo a medio crear
                    // (mismo patrón que ya se usa en RegisterDueno para "Dueño").
...
<div style='font-family: Arial, Helvetica, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f4f4f4; padding: 30px 0;'>
    <div style='background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.08);'>
        ...
        <div style='padding: 32px 24px;'>
            <h2 style='color: #1a1a1a; margin-top: 0; font-size: 20px;'>¡Bienvenido!</h2>
